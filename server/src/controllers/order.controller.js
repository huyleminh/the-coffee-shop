...
class OrderController {
    static createOrder = async (req, res) => {
        ...
        while (aliasIdList.includes(aliasId)) aliasId = orderIdLib.generate();
        ...
        const insertProductOrderList = await ProductOrder.insertList(
            productOrderList
        );
    ...
    static getAll = async (req, res) => {
        ...
        for (let order of orderList)
            productsList.push(
                await ProductOrder.getAllProductByOrderId(order.id)
            );
